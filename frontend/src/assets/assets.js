...
export const products = [
    {
        ...
        description: "Experience the power of the M3 chip in a compact 14-inch design. Perfect for professionals on the go.",
        price: 1599,
        image: [p_img1],
    ...
    },
    {
        _id: "aaaab",
        name: "Dell XPS 15",
        description: "Stunning 4K OLED display with powerful performance for creators and business professionals.",
        price: 1899,
    ...
    },
    {
        ...
        description: "Level up your gaming experience with the ultimate performance and high refresh rate screen.",
        price: 1399,
        image: [p_img3],
    ...
    },
    {
        _id: "aaaad",
        name: "HP Pavilion 15",
        description: "Perfect balance of performance and portability for students and everyday tasks.",
        price: 649,
        image: [p_img4],
